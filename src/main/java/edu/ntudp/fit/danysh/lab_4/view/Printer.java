package edu.ntudp.fit.danysh.lab_4.view;

import edu.ntudp.fit.danysh.lab_4.model.*;
...
public class Printer {
    ...
    public void printUniversityTree(University University) {
        ...
        for (edu.ntudp.fit.danysh.lab_4.model.Faculty Faculty : Faculties) {
    ...
    public void printFacultyTree(Faculty Faculty) {
        ...
        for (edu.ntudp.fit.danysh.lab_4.model.Department Department : Departments) {
    ...
    public void printDepartmentTree(Department Department) {
        ...
        for (edu.ntudp.fit.danysh.lab_4.model.Group Group : Groups) {
    ...
    public void printGroupTree(Group Group) {
        ...
        for (edu.ntudp.fit.danysh.lab_4.model.Student Student : Students) {
